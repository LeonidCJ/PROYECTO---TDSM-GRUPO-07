...
const styles = StyleSheet.create({
  ...
  avatarRing: {
    ...
    borderWidth: 3, borderColor: colors.primaryFixed, padding: 3,
  },
  avatar: { flex: 1, borderRadius: 45, backgroundColor: "#CADDEE", alignItems: "center", justifyContent: "center" },
  initials: { fontSize: 32, fontWeight: "700", color: colors.primary, letterSpacing: 1 },
  editBadge: {
    ...
    shadowColor: colors.primary, shadowOpacity: 0.3, shadowRadius: 4, shadowOffset: { width: 0, height: 2 },
  },
  name: { fontSize: 22, fontWeight: "700", color: colors.text, letterSpacing: 0.2, marginBottom: 4 },
  role: { fontSize: 13, color: colors.subtext, fontWeight: "500" },
  card: {
    backgroundColor: colors.surface, borderRadius: 20, borderWidth: 1,
    borderColor: colors.cardBorder, paddingHorizontal: 18, paddingVertical: 16,
  ...
  cardLabel: { fontSize: 11, fontWeight: "700", color: colors.subtext, letterSpacing: 1 },
  emailBlock: { backgroundColor: colors.surfaceContainerLow, borderRadius: 10, padding: 12, marginBottom: 2 },
  emailLabelRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 6 },
  fieldLabel: { fontSize: 10, fontWeight: "700", color: colors.subtext, letterSpacing: 0.8 },
  lockedBadge: {
    flexDirection: "row", alignItems: "center", gap: 3,
    backgroundColor: colors.surfaceContainerHigh, paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4,
  },
  lockedText: { fontSize: 9, color: colors.subtext, fontWeight: "600" },
  fieldRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  fieldValue: { fontSize: 14, color: colors.text, flex: 1, marginRight: 8, fontWeight: "500" },
  divider: { height: 1, backgroundColor: colors.cardBorder, marginVertical: 14 },
  changePasswordRow: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", paddingVertical: 2 },
  changePasswordLeft: { flexDirection: "row", alignItems: "center" },
  changePasswordText: { fontSize: 15, color: colors.text, fontWeight: "500" },
  signOutButton: {
    flexDirection: "row", alignItems: "center", justifyContent: "center",
    borderWidth: 1.5, borderColor: colors.error, borderRadius: 14, paddingVertical: 15,
    backgroundColor: colors.surface, shadowColor: colors.error,
    shadowOpacity: 0.08, shadowRadius: 6, shadowOffset: { width: 0, height: 2 },
  },
  signOutText: { fontSize: 15, fontWeight: "600", color: colors.error },
  footer: { fontSize: 11, color: colors.outline, textAlign: "center", marginTop: 4, lineHeight: 17, paddingHorizontal: 16 },
});
